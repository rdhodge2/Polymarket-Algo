...
# Market timing
MIN_TIME_BEFORE_EXPIRY = 3
MAX_TIME_BEFORE_EXPIRY = 12
MARKET_LOOKUP_WINDOW = 20
...
SPREAD_THRESHOLD_CURRENT = 0.03
SPREAD_THRESHOLD_NEXT = 0.04
SPREAD_THRESHOLD_FUTURE = 0.06
